...
function Projects() {
  return (
    <section
      id="project"
      className="w-full min-h-screen text-white flex flex-col items-center px-4"
    >
      {/* Heading */}
...
Some of my latest projects showcasing clean code, responsive design, and end-to-end solutions that combine design with functionality.        </p>
      ...
      {/* Projects */}
      <div className="flex flex-col items-center gap-12 mb-10 relative w-full min-h-[300vh]">
