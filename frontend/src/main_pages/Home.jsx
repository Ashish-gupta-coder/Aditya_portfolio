...
import Resume from "../assets/Aditya_Mehrotra.pdf";
      ...
      <div className="w-[80%] flex flex-col items-center gap-5 text-center">
        ...
        <div className="flex flex-col gap-4" data-aos="zoom-in">
          <h1 className="text-5xl font-bold">
            MERN stack web <span className="text-[#13d3c4]">developer</span>
          </h1>
        ...
        <div className="flex gap-5 font-medium">
          <a href="#contact" data-aos="zoom-in" data-aos-offset="0">
            <button className="w-[130px] h-[35px] bg-[#10beb0] rounded-2xl text-xs flex items-center justify-center gap-1">
