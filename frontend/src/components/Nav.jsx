...
function Nav() {
  ...
  // ✅ Always black (only change)
  const navBg = "bg-[#0e0c1f] shadow-md";
    ...
    >
      <div className="w-[90%] flex items-center justify-between text-white relative">
        <div className="font-extrabold text-3xl px-3" data-aos="zoom-in">
          <h1>
            Aditya <span className="text-[#13d3c4]">Mehrotra</span>.
          </h1>
        </div>

        <ul
          className="hidden md:flex items-center text-sm text-gray-500 gap-8"
          data-aos="zoom-in"
        >
          <li className="hover:text-[#13d3c4] cursor-pointer">
            <a href="#home">Home</a>
          </li>
          <li className="hover:text-[#13d3c4] cursor-pointer">
      ...
      {show && (
        <div
          className="fixed top-0 right-0 w-[80vw] h-screen bg-black z-50 flex items-center justify-center"
          data-aos="fade-left"
          data-aos-duration="400"
        >
          <div className="w-14 h-14 absolute top-5 right-5 md:hidden flex items-center justify-center rounded-md z-10">
            <button
              className="text-white md:text-3xl text-4xl hover:text-[#13d3c4] flex items-center gap-2 cursor-pointer"
              onClick={() => setShow((prev) => !prev)}
            >
              <IoIosClose />
            </button>
          ...
          <ul className="md:hidden flex flex-col items-center text-xl text-gray-500 gap-8">
            <li
              className="hover:text-[#13d3c4] cursor-pointer"
              data-aos="fade-left"
              data-aos-duration="400"
              data-aos-delay="100"
